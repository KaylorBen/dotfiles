...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "u", function()
		xrandr.xrandr()
	end, { description = "xrandr screen configuration", group = "awesome" }),
	...
	awful.key({ modkey }, ";", function()
		set_wallpapers()
	end, { description = "reset wallpapers", group = "awesome" }),
...
awful.spawn("xrandr --output HDMI-0 --rotate right --right-of DP-0 --scale 1.25x1.25")
awful.spawn("xrandr --output DP-0 --pos 0x0 --primary")
